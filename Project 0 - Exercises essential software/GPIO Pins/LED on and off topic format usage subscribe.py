...
def on_message(client, userdata, message):
	...
	# Catch errors
	try:
		homeZone=message.topic.split("/")
		pinNums=client.pinHome.get(homeZone)
...
def main():
	...
	# Setup dictonary pin keys values
	pinHome={"cocina0":[2, 5, 7], "habitacion0":[3,4,6], "garaje0":[10,13,18,20,23,24,25]}
	client.pinHome=pinHome
